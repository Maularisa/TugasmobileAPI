import 'package:httprequest/api_data_source.dart';
import 'package:httprequest/page_detail_user.dart';
import 'package:httprequest/user_model.dart';
...
// Jika data ada error maka akan ditampilkan hasil error
    ...
    if(snapshot.hasData){
// Jika data ada dan berhasil maka akan ditampilkan
      hasil datanya
  ...
  Widget _buildItemUsers(Data userData) {
    return InkWell(
      onTap: () => Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => PageDetailUser(idUser:
              userData.id!,))
      ),
      child: Card(
      child: Row(
